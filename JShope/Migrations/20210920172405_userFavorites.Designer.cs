...
namespace JShope.Migrations
{
    ...
    [Migration("20210920172405_userFavorites")]
            ...
            modelBuilder.Entity("JShope.Models.Product", b =>
                {
                    ...
                    b.Property<int?>("UserFavoritesFavoritesId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserFavoritesFavoritesId");
            ...
            modelBuilder.Entity("JShope.Models.Product", b =>
                {
                    ...
                    b.HasOne("JShope.Models.UserFavorites", "UserFavorites")
                        .WithMany("Products")
                        .HasForeignKey("UserFavoritesFavoritesId");
